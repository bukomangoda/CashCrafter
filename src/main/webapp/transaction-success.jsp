			...
			<div class="container" style="margin-top: 10%; background: #5fff7096;">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title" style="margin-top: 122px; text-align: center; font-size: 43px">Transaction successfully completed!</h2>
						<div class="form-group form-button" style="text-align: center;">
    						<a href="balance-inquiry.jsp" class="form-submit">Back</a>
						</div>
					</div>
					
					<div class="signup-image">
						<figure>
							<img src="images/success.png" alt="sing up image">
						</figure>
					</div>
				</div>
			</div>
